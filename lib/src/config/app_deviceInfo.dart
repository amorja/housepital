...
import 'package:housepital/src/utils/device_utils.dart';
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: Container(
        ...
        color: AppFlavorConfig.instance.color,
        child: Text(
          ' Device Info',
    ...
    return FutureBuilder(
        ...
        builder: (context, AsyncSnapshot<IosDeviceInfo> snapshot) {
          ...
          return SingleChildScrollView(
            child: Column(
              children: <Widget>[
                _buildTile('Flavor:', '${AppFlavorConfig.instance.name}'),
                ...
                _buildTile('System version:', '${device.identifierForVendor}'),
          ...
          return SingleChildScrollView(
            child: Column(
              children: <Widget>[
                ...
                _buildTile('Android ID:', '${device.androidId}'),
