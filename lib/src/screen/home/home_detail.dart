...
class _DetailedPageState extends State<DetailedPage> {
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text('3 Result Found',style: Styles.primaryTextwithf18,),
                Divider(color: black75,),
                SizedBox(height:12.0),
                container2('lib/assets/images/image1.jpg','Nursing 24 hours','Per day - 3000 Rs'),
                SizedBox(height:8.0),
                container2('lib/assets/images/image2.jpg','Nursing 12 hours','Per day - 1500 Rs'),
                SizedBox(height:8.0),
  ...
  Widget container1(){
    return Container(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Text('${widget.argu['data_heading']}',style: Styles.blackTextwithf24w6,),
          SizedBox(height:12.0),
          Text('We have highly-qualified and experienced nurses who are trained to deliver top-notch nursing services which include post-surgical care, elderly care, chronic care, tracheostomy care, urinary catheterization care, wound care, injections, IV infusions, vaccination or other nursing assistance.',style: Styles.blackopacity5f18wlineheight,)
        ],
      ),
    );
  }
  Widget container2(image,title,subtitle){
    return GestureDetector(
      onTap: (){
        Navigator.pushNamed(context, pageExtanded,arguments: {'title':title, 'image':image ,});
      },
      child: Material(
        elevation: 8.0,
